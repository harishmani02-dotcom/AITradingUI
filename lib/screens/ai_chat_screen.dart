...
class AIService {
  // NOTE: Using the Groq API endpoint with the key provided by the user.
  static const String _groqApiKey = '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';
