...
class _AIChatScreenState extends State<AIChatScreen> with SingleTickerProviderStateMixin {
  ...
  // Updated Quick Questions focusing on theoretical stock market concepts
  final List<String> _quickQuestions = [
    "Explain the **Efficient Market Hypothesis** and its three forms.",
    "What are the core differences between **Value Investing** and **Growth Investing**?",
    "Describe the concept of **Systematic Risk** versus Unsystematic Risk.",
    "Define **Modern Portfolio Theory (MPT)** and the Efficient Frontier.",
    "What is the significance of the **Capital Asset Pricing Model (CAPM)**?",
    "How does the **Discounted Cash Flow (DCF)** method work for valuation?",
  ];
  ...
  void _sendMessage(String text) async {
    ...
    // Use a placeholder text to display the formatted text in the bubble
    ...
    try {
      // Send the clean text to the AI service
      final aiResponse = await AIService.getAIResponse(displayText);
                        ...
                        children: _quickQuestions.map((question) {
                          return InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                // Remove markdown bolding for display in the button
                                question.replaceAll('**', ''),
          ...
          Flexible(
            child: Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Use SelectableText to allow copying and to render rich text if needed (e.g., bolding)
                  SelectableText(
                    message.text,
                    style: const TextStyle(
                      fontSize: 14,
